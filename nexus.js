...
const Nexus = {
        ...
        const helpHTML = `
            <div style="line-height: 1.6;">
                ...
                <ul style="padding-left: 20px;">
                    <li><b>File Importer:</b> Use the 'Import' button to load multiple files simultaneously.</li>
                    <li><b>Voice Commands (🎙️):</b> Click the mic and dictate commands like "build" or "pwa".</li>
                    <li><b>Math Engine:</b> In the terminal, type <code>= 50 * 4</code> to compute equations.</li>
    ...
    formatCode() {
        if (!this.state.active || (!this.state.cm && !this.state.popupCm)) return;
        const activeView = this.state.popupCm || this.state.cm;
    ...
    startVoice() {
        ...
        if (!SpeechRecognition) {
            this.log("Voice dictation not supported.", "var(--danger)");
            return;
        }
    ...
    async createBranch(name) {
        ...
        this.log(`Switched to branch: ${id}`, 'var(--success)');
        this.renderBranches();
    },
...
const Hardware = {
    initShakeToUndo() {
        ...
        window.addEventListener('devicemotion', (e) => {
            ...
            if (delta > 15) { 
                Nexus.log("Shake detected: Undoing...");
